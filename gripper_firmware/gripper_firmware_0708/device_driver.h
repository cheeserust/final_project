...
extern void Uart2_RX_Interrupt_Enable(int en);  //통신부 인터럽트
...
// Uart.c - servo_send
extern void Uart1_Send_Binary(unsigned char data);
// Uart.c - servo_feedback
// extern void Uart1_Flush_Rx(void);
extern int Uart1_Get_Char_Timeout(int timeout_loops);
