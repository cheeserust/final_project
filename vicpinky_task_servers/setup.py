...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'floor5_delivery_sequence = vicpinky_task_servers.floor5_place_return_sequence:main',
            'floor5_place_return_sequence = vicpinky_task_servers.floor5_place_return_sequence:main',
