...
| `/arm_controller/execute_joint_goal` | `ExecuteArmGoal` | `arm_can_bridge` | validated direct joint clients |
...
| --- | --- | --- |
| `arm_controller` | `/arm_controller/execute_joint_goal` | `base_joint`, `arm_joint_1`~`arm_joint_4` |
...
| `arm_joint_1` | 1 | 0 | -85 | 90 | -86.5 | -8500 | 9000 | -8650 |
...
| --- | --- | --- | --- |
| Board1 | `arm_joint_1~3 + base_joint` | `0x101` | `0x201` |
| Board2 | `arm_joint_4` | `0x102` | `0x202` |
