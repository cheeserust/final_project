/*
 * Arduino Uno/Nano Board2 firmware for the base axis.
 *
 * Libraries:
 ...
 * - TB6600: STEP D6, DIR D7, EN D8 active-low
...
static const float HOMING_STEP_RATE_SPS = 1000.0f;
...
static void serviceMotion()
{
    ...
    if (activeTargetStep > currentStep && limitDebounced) {
...
static void serviceHoming()
{
    ...
    state = STATE_HOMING;
    stepper.setSpeed(HOMING_STEP_RATE_SPS);
    stepper.runSpeed();
    syncCurrentStep();
}
